...
int main(int argc, char** argv, char** env) {
	...
	while (!done)
	{
        ...
        //mem_edit_1.DrawContents(top->top__DOT__soc__DOT__vga__DOT__vmem__DOT__mem, 16384, 0);
                mem_edit_1.DrawContents(&top->rootp->top__DOT__soc__DOT__rom__DOT__mem, 4096, 0);
                ImGui::End();
                ImGui::Begin("RAM Editor");
                //mem_edit_1.DrawContents(top->top__DOT__soc__DOT__vga__DOT__vmem__DOT__mem, 16384, 0);
                mem_edit_2.DrawContents(&top->rootp->top__DOT__soc__DOT__ram__DOT__mem, 4096, 0);
                ImGui::End();
                ImGui::Begin("VRAM Editor");
                //mem_edit_1.DrawContents(top->top__DOT__soc__DOT__vga__DOT__vmem__DOT__mem, 16384, 0);
                mem_edit_3.DrawContents(&top->rootp->top__DOT__soc__DOT__vga__DOT__vmem, 16000, 0);
                ImGui::End();
